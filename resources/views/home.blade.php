            ...
            <div class="row d-flex">
                <div class="col-sm-12 col-md-12 col-lg-6  mt-5">
                    <div class="copy">
                        ...
                        <div class="text-hero-regular text-secondary">Mungkin sistem triase tidak sesederhana sistem antrian (<p class="fst-italic d-inline">first come first serve</p>), tapi ini diperlukan untuk memperlakukan pasien secara adil sesuai dengan gejala yang dialami pasien.</div>
                        <div class="cta">
