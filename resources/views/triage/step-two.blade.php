                        ...
                        <div class="card-body">
                            <form action="{{ route('triage.step.two.process') }}" method="post">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="text" name="sbp" class="form-control" placeholder="120" value="{{ old('sbp', session()->get('triage')->sbp ?? '') }}">
                                        <small class="form-hint">Tekanan darah maksimum selama kontraksi ventrikel.</small>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="text" name="hr" class="form-control" placeholder="70" value="{{ old('hr', session()->get('triage')->hr ?? '') }}">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="text" name="rr" class="form-control" placeholder="20" value="{{ old('rr', session()->get('triage')->rr ?? '') }}">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="text" name="bt" class="form-control" placeholder="37" value="{{ old('bt', session()->get('triage')->bt ?? '') }}">
                                        <small class="form-hint">Skala suhu tubuh yang digunakan adalah skala celcius ℃.</small>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-3 col-form-label required">Saturasi oksigen</label>
                                    <div class="col">
                                        <input type="text" name="saturation" class="form-control" placeholder="98" value="{{ old('saturation', session()->get('triage')->saturation ?? '') }}">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        ...
                                        <small class="form-hint">Tersedia alat yang dapat digunakan untuk memberikan oksigen ekstra kepada pasien, seperti tabung oksigen, masker oksigen, atau kanula hidung.</small>
                                    </div>
                                </div>
                                <div class="mb-3 row">
