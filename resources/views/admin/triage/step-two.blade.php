...
<x-app-layout>
    <x-slot:title>Tanda vital</x-slot:title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.triage.step.two.process') }}" method="post">
                                @csrf
                                @method('POST')
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="number" step="0.01" name="saturation"
                                            class="form-control @error('saturation') is-invalid @enderror" placeholder="98"
                                ...
                                <div class="container d-flex align-items-center justify-content-center">
                                    <a href="{{ route('admin.triage.step.one') }}" class="">Kembali ke langkah
                                        awal</a>
                                </div>
                            </form>
                        </div>
