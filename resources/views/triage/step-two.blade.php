                        ...
                        <div class="card-body">
                            <form action="{{ route('triage.step.two.process') }}" method="post">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="number" name="sbp" class="form-control" placeholder="120">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="number" name="dbp" class="form-control" placeholder="80">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="number" name="hr" class="form-control" placeholder="70">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="number" name="bt" class="form-control" placeholder="37">
                                        <small class="form-hint">Body temperature in ℃.</small>
                                    </div>
                                </div>
                                <div class="mb-3 row">
