...
@endphp
<x-app-layout>
    <x-slot:title>Ubah data triase pasien</x-slot:title>
    <div class="page-wrapper">
        <x-page-header title="Ubah data triase pasien" />
        <x-page-body>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('admin.triage.update', $triage->id) }}" method="post">
                                @csrf
                                @method('POST')
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <select name="gender" class="form-select">
                                            <option value="male" @selected(old('gender', $triage->gender ?? '') == 'male')>Laki-Laki</option>
                                            <option value="female" @selected(old('gender', $triage->gender ?? '') == 'female')>Perempuan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <select name="triage_vital_o2_device" class="form-select">
                                            <option value="1" @selected(old('triage_vital_o2_device', $triage->triage_vital_o2_device ?? '') == 1)>Ya</option>
                                            <option value="0" @selected(old('triage_vital_o2_device', $triage->triage_vital_o2_device ?? '') == 0)>Tidak</option>
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        ...
                                        <small class="form-hint">Isi keluhan jika ingin memperbarui data keluhan
                                            utama.</small>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <select name="validation"
                                            ...
                                            <option value="1" @selected(old('gender', $triage->validation ?? '') == '1')>Level 1</option>
                                            <option value="2" @selected(old('gender', $triage->validation ?? '') == '2')>Level 2</option>
                                            <option value="3" @selected(old('gender', $triage->validation ?? '') == '3')>Level 3</option>
                                            <option value="4" @selected(old('gender', $triage->validation ?? '') == '4')>Level 4</option>
                                            <option value="5" @selected(old('gender', $triage->validation ?? '') == '5')>Levle 5</option>
                                        </select>
                                        @error('validation')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-hint">Jika hasil artificial triase tidak sesuai ubah dengan
                                            level triase yang seharusnya.</small>
                                ...
                                <button type="submit" class="btn btn-primary w-100 mb-3">Perbarui</button>
